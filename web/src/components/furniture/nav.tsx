    ...
    <>
      ...
      <div class="navbar bg-base-100">
        ...
        <div class="flex-none hidden md:flex">
          <ul class="menu menu-horizontal px-1">
            <li>
              <details>
                ...
                <ul class="p-2 bg-base-100 rounded-t-none z-10">
                  {data.value && Array.isArray(data.value) && data.value.map((item: Section, index: number) => (
            ...
            <li>
              <a href="https://github.com/o0om/lunar-security-checklist"
      ...
      <div class="drawer-side z-10">
        ...
        <ul class="rounded-box menu p-4 w-80 min-h-full bg-base-200">
          ...
          <li><a href="https://github.com/o0om/lunar-security-checklist">
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="https://github.com/o0om/lunar-security-checklist/?tab=readme-ov-file#contributing">Contributing</a>
              </li>
              <li>
                <a href="https://github.com/o0om/lunar-security-checklist/blob/main/LICENSE">License</a>
              </li>
            </ul>
          </li>
        </ul>
